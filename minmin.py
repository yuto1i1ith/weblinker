...
print("----2----")
tworaw=[getif(i) for i in zone]
#flatlist is canot eat None
twonone=filter(None,tworaw)
two=flatlist(twonone)
#print(two)
xtwo=listandlist(alllist,two)
ztwo=list(filter(lambda x:x not in xtwo,two))
alllist=alllist+ztwo
alllist=list(set(alllist))
print(alllist)
#print(ztwo)
...
print("----3----")
threeraw=[getif(i) for i in ztwo]
#flatlist is canot eat None
threenone=filter(None,threeraw)
three=flatlist(threenone)
#print(two)
xthree=listandlist(alllist,three)
zthree=list(filter(lambda x:x not in xthree,three))
alllist=alllist+zthree
alllist=list(set(alllist))
print(alllist)
#print(ztwo)
